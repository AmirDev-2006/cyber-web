...
export default function CardPopular(prop:Card){
    return(
        <>
        <div className={`sm:w-1/4 h-[640px]  w-[475px]  sm:ml-0 pr-6   flex flex-col sm:items-center items-start justify-center  ${prop.bgcolor}`}>    
            <img src={prop.img} alt="" />
            <br />
            <div className={`w-[296px] ${prop.contstyle} h-[208px] sm:ml-0 ml-12 flex flex-col items-center`}>
