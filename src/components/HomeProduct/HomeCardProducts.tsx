...
export default function HomeCard(props:Card){
    return(
        <>
        <div className=" bg-[#F6F6F6] justify-evenly flex flex-col items-center sm:justify-center md:w-[268px] gap-y-2 md:h-[432px] w-[163px] h-[352px] rounded-lg md:px-3 py-2 px-4 md:py-6">
            ...
            <div className="flex flex-col sm:mb-0  mb-12 gap-y-3 justify-between items-center w-[140px] h-[88px] md:w-[236px] md:h-[160px]">
